        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/finance" className="text-gray-600 hover:text-primary">
                  금융 정보
                </Link>
              </li>
              <li>
                <Link href="/side-hustles" className="text-gray-600 hover:text-primary">
                  부업 아이디어
                </Link>
              </li>
              <li>
                <Link href="/community" className="text-gray-600 hover:text-primary">
                  커뮤니티
                </Link>
              </li>
              <li>
                <Link href="/hot-issues" className="text-gray-600 hover:text-primary">
                  유익한 정보 & 핫이슈
                </Link>
              </li>
            </ul>
